...
#       python ${baseUrl}/baselines/method1/src/pvqa_adv.py \
#       --train train --valid val  \
#       --llayers 9 --xlayers 5 --rlayers 5 \
#       --loadLXMERT ${baseUrl}/baselines/method1/snap/pretrained/model \
#       --batchSize 32 --optim bert --lr 5e-5 --epochs 60 \
...
#       --tqdm --output $ft_output
  ...
  # See Readme.md for option details.
  CUDA_VISIBLE_DEVICES=0 PYTHONPATH=$PYTHONPATH:./src \
      python ${baseUrl}/baselines/method1/src/pvqa_compare_models_using_test_dataset.py \
